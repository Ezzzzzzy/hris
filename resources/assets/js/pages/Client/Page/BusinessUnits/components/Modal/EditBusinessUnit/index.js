...
class EditBusinessUnit extends Component {
    constructor(props) {
        ...
        this.state = {
            data: {
                ...
                business_unit_name: this.props.data.business_unit_name,
        ...
        for (let x = 0; x < requiredFields.length; x++) {
            ...
            if (value.replace(/\s/g, "") === "" || !format.test(value)) {
                ...
                if (!format.test(value))
                    errorMsg[requiredFields[x]] = "This field should not contain any special characters.";
    ...
    onSubmit(e) {
        ...
        if (this.formValidation()) {
            this.props.editBusinessUnit(this.state.data);
                        ...
                        <div className="modal-content">
                            <form onSubmit={(e) => this.onSubmit(e)}>
                                <div className="modal-header modal-header-color">
                                    <h5 className="modal-title" id="AddBrand">Edit Business Unit</h5>
                                ...
                                <div className="modal-body my-3">
                                    <div className="row">
                                        <div className="col text-left">
                                            ...
                                            />
                                            <span className="text-danger">{this.state.errorMsg.business_unit_name}</span>
                                        </div>
                                    </div>
                                    <div className="row mt-3">
                                        <div className="col text-left">
                                            <TextInput
                                                ...
                                                errors={this.state.errors}
                                            />
                                            <span className="text-danger">{this.state.errorMsg.code}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="modal-footer">
                                    <button type="submit" className="btn btn-primary btn-success">Update Business Unit</button>
                                </div>
                            </form>
                        </div>
                    </div>
